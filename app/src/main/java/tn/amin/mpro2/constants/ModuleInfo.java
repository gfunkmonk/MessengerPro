...
public class ModuleInfo {
    ...
    public static final int MIN_ORCA_VERSION = 322009746;
    public static final int MAX_ORCA_VERSION = Integer.MAX_VALUE;
    public static final String RECOMMENDED_ORCA_VERSION_STRING = "460.0.0.48.109";
