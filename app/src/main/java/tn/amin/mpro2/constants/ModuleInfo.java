...
public class ModuleInfo {
    ...
    public static final int MIN_ORCA_VERSION = 343612227;
    public static final int MAX_ORCA_VERSION = 343612312;
    public static final String RECOMMENDED_ORCA_VERSION_STRING = "568.0.0.46.89";
